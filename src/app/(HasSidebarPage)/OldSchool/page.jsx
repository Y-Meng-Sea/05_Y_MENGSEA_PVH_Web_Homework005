        ...
        return(
          ...
          <div className="relative">
            <div className="aspect-w-4 aspect-h-4 bg-gray-500 rounded-3xl">
              <div className="w-full h-full flex items-center justify-center shadow-lg rounded-3xl">
                <img alt={data.ct_title} src= {data.image} className='w-full h-full object-cover rounded-3xl'/>
              </div>
            </div>
          </div>
          ...
          <div className="p-3">
            ...
            <div className="flex items-center mt-1 text-xs text-gray-500">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-blueCustom" viewBox="0 0 20 20" fill="currentColor">
